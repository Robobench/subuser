...
import robobenchlib.classes.hostMachine
...
def installImage(imageSource, useCache=False,parent=None):
  ...
  hostmachine = robobenchlib.classes.hostMachine.HostMachine(imageSource.getUser(),"","")
  hostmachine.generateAndLoadFromScript()
